...
<script src="<?php echo site_url();?>/wp-content/uploads/janpaepke-ScrollMagic-d7743a2/assets/js/lib/greensock/TweenMax.min.js"></script>
<script src="<?php echo site_url();?>/wp-content/uploads/janpaepke-ScrollMagic-d7743a2/scrollmagic/uncompressed/ScrollMagic.js"></script>
<script src="<?php echo site_url();?>/wp-content/uploads/janpaepke-ScrollMagic-d7743a2/scrollmagic/uncompressed/plugins/animation.gsap.js"></script>
<script src="<?php echo site_url();?>/wp-content/uploads/janpaepke-ScrollMagic-d7743a2/scrollmagic/uncompressed/plugins/debug.addIndicators.js"></script>
<script>
...
<section class="home_banner_area headerBlock pb-2 parallaxParent">
		<div class="container">
...
<?php for($block_counter = 1 ; $block_counter < 6 ; $block_counter++){?>
<div class="blockContainer<?php echo $block_counter;?>">	
<?php if(get_field("block".$block_counter."label") != ""){
	if(get_field("block".$block_counter."type") == "text"){?>
		<section id="parallax<?php echo $block_counter;?>" class="text_block row block".$block_counter." pb-2 parallaxParent">
		<div class="row"><?php echo get_field("block".$block_counter."text");?></div>
		</section>
		<script>
		new ScrollMagic.Scene({triggerElement: "#parallax<?php echo $block_counter;?>"})
		.setTween("#parallax<?php echo $block_counter;?> > div", {y: "80%", ease: Linear.easeNone})
		.addIndicators()
		.addTo(controller);
		</script>
	<?php }
	else if(get_field("block".$block_counter."type") == "embed"){?>
		<section id="parallax<?php echo $block_counter;?>" class="embedd_html row block<?php echo $block_counter;?> pb-2 parallaxParent">
		...
		<script>
		new ScrollMagic.Scene({triggerElement: "#parallax<?php echo $block_counter;?>"})
		.setTween("#parallax<?php echo $block_counter;?> > div", {y: "30%", ease: Linear.easeNone})
		.addIndicators()
		.addTo(controller);
		</script>
	<?php }
	...
	?>
	<section id="parallax<?php echo $block_counter;?>" class="home_banner_area block<?php echo $block_counter;?> pb-2 parallaxParent" style="position: relative;">
		<div class="container">
			<div class="banner_content">
				<div class="image-container">
	...
	<?php }
		...
		?>
		<section id="parallax<?php echo $block_counter;?>" class="embedd_video block<?php echo $block_counter;?> pb-2 parallaxParent">
		...
		?>
		<section id="parallax<?php echo $block_counter;?>" class="map_block block<?php echo $block_counter;?> pb-2 parallaxParent">
	...
	?>
	<section id="parallax<?php echo $block_counter;?>" class="home_banner_area block<?php echo $block_counter;?> pb-2 parallaxParent">
		<div class="row ml-2">
			<div class="col-6">
	...
	?>
	<section class="home_banner_area block<?php echo $block_counter;?> pb-2 parallaxParent">
		<div class="row ml-2">
			<div class="col-6">
	...
	?>
	<section class=" pb-2 parallaxParent">
		<div class="row ml-2">
			<div class="col-6">
...
<script>
  ...
  var index_names =[];
          ...
          data: { map_id : mapTypeId , flag:1},
            ...
            success: function (data) {
              ...
              maxZoom: 19
        	    ...
        	    for (var i=0;i<j;i++){
        	      loadData(data[i], icon_data[i], mymap);
        	    }
    ...
    function loadData(indexData, icon_details, mymap){
	...
	var blockCounter = 1;
	var blockHeight = 0;
	var hT = $('.blockContainer' + blockCounter).offset().top,
    hH = $('.blockContainer' + blockCounter).outerHeight(),
    wH = $(window).height();
	blockHeight = hT+hH-wH;
