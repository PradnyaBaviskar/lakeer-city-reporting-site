...
<?php if(get_field("block".$block_counter."label") != ""){
	...
	?>
	<section class="parallax home_banner_area block<?php echo $block_counter;?> pb-2" data-image-src="<?php echo get_field("block".$block_counter."combimagetext_image")['url']; ?>" style="background-image: url('<?php echo get_field("block".$block_counter."combimagetext_image")['url']; ?>'); background-position: center 144px;">
		<div class="row ml-2">
			<div class="col-12">
	...
	<?php }/*else if(get_field("block".$block_counter."type") == "image-text"){
	?>
